 ...
 *
 */
+ (void) snackBarWithMessage:(NSString*) message font:(UIFont*)font backgroundColor:(UIColor*) bgColor textColor:(UIColor*) textColor actionTitle:(NSString*)actionTitle actionTitleColor:(UIColor *)actionTitleColor delegate:(id) delegate duration:(float) duration;
